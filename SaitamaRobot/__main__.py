...
EMILIA_IMG = "https://telegra.ph/file/851b1a3822ae3340eca36.jpg"
...
PM_START_TEXT = """
Hᴇʏ Tʜᴇʀᴇ! [🧑🏻‍💻](https://telegra.ph/file/851b1a3822ae3340eca36.jpg) Mʏ ɴᴀᴍᴇ ɪs Mʀ Bᴇɴ 𝟷𝟶
...
buttons = [
    [
        InlineKeyboardButton(
            text="✪ Aᴅᴅ Mʀ Bᴇɴ 𝟷𝟶 Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ ✪",url="t.me/Ben_10_Robot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(
              text="✘ Cᴏᴍᴍᴀɴᴅ & Hᴇʟᴘ ✘", callback_data="help_back"),
     
    ],
    [
        InlineKeyboardButton(
            text="『 Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ 』", url="https://t.me/PigasusUpdates"),
    ],
    [
        InlineKeyboardButton(
            text="『 Lᴏɢs Cʜᴀɴɴᴇʟ 』", url="https://t.me/PigasusLogs"),
          


InlineKeyboardButton(
            text="『 Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ 』", url="https://t.me/PigasusSupport"
        ),

    ],
    [
        InlineKeyboardButton(
                    text="░ Bᴏᴛ Cʀᴇᴀᴛᴏʀ ░", url="https://t.me/DreamerNo1"
        ),
    ],
]
...
HELP_STRINGS = """
Hᴇʏ ᴛʜᴇʀᴇ! Mʏ Nᴀᴍᴇ Is [Mr Ben 10]("https://telegra.ph/file/851b1a3822ae3340eca36.jpg") 
I'ᴍ ᴀ Hᴀʟғ Mᴀɴ ᴀɴᴅ Hᴀʟғ Aʟɪᴇɴs I ʜᴇʟᴘ ᴀᴅᴍɪɴs ᴍᴀɴᴀɢᴇ ᴛʜᴇɪʀ ɢʀᴏᴜᴘs ᴡɪᴛʜ Sᴏᴍᴇ Pᴏᴡᴇʀғᴜʟ Fᴇᴀᴛᴜʀᴇs! Hᴀᴠᴇ ᴀ ʟᴏᴏᴋ ᴀᴛ ᴛʜᴇ ғᴏʟʟᴏᴡɪɴɢ ғᴏʀ ᴀɴ ɪᴅᴇᴀ ᴏғ sᴏᴍᴇ ᴏғ ᴛʜᴇ ᴛʜɪɴɢs I ᴄᴀɴ ʜᴇʟᴘ ʏᴏᴜ ᴡɪᴛʜ."""

DONATE_STRING = """
Hᴇʏᴀ, ɢʟᴀᴅ ᴛᴏ ʜᴇᴀʀ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴅᴏɴᴀᴛᴇ!
I'ᴅ Lɪᴋᴇ ʏᴏᴜ ᴛᴏ Dᴏɴᴀᴛᴇ ᴛʜᴀᴛ Mᴏɴᴇʏ ᴛᴏ Sᴏᴍᴇ Cʜᴀʀɪᴛʏ. 
Tʜᴀɴᴋs Fᴏʀ A Tʜᴏᴜɢʜᴛ Pᴀʏ Us Iғ U Sᴛɪʟʟ Hᴀᴠᴇ Tᴏ Pᴀʏ Us Tʜᴇɴ Jᴏɪɴ Oᴜʀ Sᴜᴘᴘᴏʀᴛ @PigasusSupport!
"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            EMILIA_IMG, caption= "Mr Ben 10 is Here For You\nI am Awake Since: <code>{}</code>".format(
                uptime
            ),
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  ...
                  [
                  InlineKeyboardButton(text="Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ", url="https://telegram.dog/PigasusUpdates")
                  ]
                ]
            ),
        )
...
def error_handler(update, context):
    """Lᴏɢ Tʜᴇ Eʀʀᴏʀ ᴀɴᴅ Sᴇɴᴅ ᴀ Tᴇʟᴇɢʀᴀᴍ Mᴇssᴀɢᴇ ᴛᴏ Nᴏᴛɪғʏ ᴛʜᴇ Dᴇᴠᴇʟᴏᴘᴇʀ."""
