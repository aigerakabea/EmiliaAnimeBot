...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="📮 Updates Channel", url="https://t.me/botcreaterss"),
    ],
    [
        InlineKeyboardButton(
...
HELP_STRINGS = """
`Hey there") I am (Valt Aoi) ("https://telegra.ph/file/eb183a86b5fc974b56d99.jpg.")
...
if __name__ == '__main__':
    ...
    telethn.start(bot_token=1972630485:AAEPoUn4t8F_6vuCu6YwF-hE3YvS2yvd1hs)
    pgram.start()
    main()
